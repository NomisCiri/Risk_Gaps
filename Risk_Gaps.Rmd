...
group_by(ReScale,subject,LinearAgeTrans,QuadraticAgeTrans,Risk,HowMany,ActualAge)%>%
  ...
  scale_color_discrete(name="Propensity to...       ", breaks=c("P_HowOften_4","P_Recom_4"),labels=c("Engage", "Recommend"))+
...
Jointplot<-cowplot::plot_grid(PredcitionsPlotUndesirable,PredcitionsPlotDesirable+theme(legend.position = "none"),labels=c("a","b"),
...
ggsave(plot=Jointplot,"X_Figures/Alltogether.png",width=12,height=10)
...
ggsave(filename = "X_Figures/RecWithoutThrill.png",width = 10,height = 5)
